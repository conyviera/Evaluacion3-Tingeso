...
class CustomerServiceTest {
    ...
    void whenNameIsNull_thenThrowsIllegalStateException() {
        ...
        // When & Then
        assertThatThrownBy(() ->
                customerService.registerCustomer(name, phoneNumber, email, rut)
        )
    ...
    void whenCustomerHasMultipleLoansOneExpired_thenReturnTrue() {
        ...
        when(customerRepository.findByRut(rut)).thenReturn(Optional.of(customer));
        when(loanRepository.findByCustomerAndStateIsNot(customer, "RETURNED"))
